  ...
  return (
    <>
      ...
      <Container>
        ...
        <Title className={Typography.L}>利用規約</Title>
        <Text className={Typography.S}>
        ...
        <SubTitle className={Typography.M}>1. 適用</SubTitle>
        <Text className={Typography.S}>
          本規約は、当サービス提供者とユーザーとの間の本サービスの利用に関わる一切の関係に適用されるものとし、ユーザーは本規約に同意する場合に限り、本サービスを利用できるものとします。
        </Text>
        <SubTitle className={Typography.M}>2. 定義</SubTitle>
        <Text className={Typography.S}>
        ...
        <SubTitle className={Typography.M}>3. 権利帰属</SubTitle>
        <Text className={Typography.S}>
          装飾素材や本サービスに関連する一切の権利は当サービス提供者、または当サービス提供者に権利許諾した第三者に帰属します。
        </Text>
        <SubTitle className={Typography.M}>
          4. サービス内容の変更と停止
        </SubTitle>
        <Text className={Typography.S}>
          当サービス提供者は、ユーザーに通知することなく本サービスの内容を変更すること、また本サービスの提供を停止することができます。
        </Text>
        <SubTitle className={Typography.M}>5. 第三者サービスの利用</SubTitle>
        <Text className={Typography.S}>
        ...
        <SubTitle className={Typography.M}>6. 禁止事項</SubTitle>
        <Text className={Typography.S}>
        ...
        <SubTitle className={Typography.M}>7. 保証の否認と免責事項</SubTitle>
        <Text className={Typography.S}>
          1.
        ...
        <SubTitle className={Typography.M}>8. 利用規約の変更</SubTitle>
        <Text className={Typography.S}>
        ...
        <SubTitle className={Typography.M}>9. 準拠法と裁判管轄</SubTitle>
        <Text className={Typography.S}>
