...
const groupTitlePc = css`
  ${groupTitle};
  text-align: right;
`;

const groupTitleSp = groupTitle;
...
const ExhibitionCredits: NextPage = dynamic(() =>
  Promise.resolve(() => {
    ...
    const group = isMobile ? groupSp : groupPc;
    const groupTitle = isMobile ? groupTitleSp : groupTitlePc;
    const buttons = isMobile ? buttonsSp : buttonsPc;
    const button = isMobile ? buttonSp : buttonPc;
        ...
        <div css={clicked ? fadeOut : fadeIn}>
          ...
          <div css={group}>
            ...
            <div>
              ...
              <div>
                Balloon-2 / beth_hanning (
                <Ancher href="https://skfb.ly/6W9Bz" />){" "}
              ...
              <div>
                Easel / Olivercharlton11 (
                <Ancher href="https://skfb.ly/6RytF" />) <CCAttribution />
              </div>
              <div>
              ...
              <div>
                Little Clover / tinyruin (
                <Ancher href="https://skfb.ly/6BWnG" />) <CCAttribution />
              </div>
              <div>
                Mail Box 2 (Usa) / gadsby (
                <Ancher href="https://skfb.ly/68yqR" />
                ) <CCAttribution />
              </div>
              <div>
              ...
              <div>
                Toon IMac / younesbelhit (
                <Ancher href="https://skfb.ly/6X6uy" />) <CCAttribution />
              </div>
              <div>
