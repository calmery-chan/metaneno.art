...
const BACKGROUND_IMAGE_MAX_HEIGHT_WHEN_MORNING = 533;
const BACKGROUND_IMAGE_MAX_WIDTH_WHEN_MORNING = 1500;
...
export const EXHIBITION_2D_PICKABLE_ANIMATION_DURATION = 0.4 * 1000;
export const EXHIBITION_2D_PICKABLE_IMAGE_HEIGHT = 15;
export const EXHIBITION_2D_PICKABLE_IMAGE_WIDTH = 9;
export const EXHIBITION_2D_PICKABLE_HEIGHT =
  EXHIBITION_2D_PICKABLE_IMAGE_HEIGHT * 2;
export const EXHIBITION_2D_PICKABLE_MAX_FRAME_COUNT = 4;
export const EXHIBITION_2D_PICKABLE_WIDTH =
  EXHIBITION_2D_PICKABLE_IMAGE_WIDTH * 2;
export const EXHIBITION_2D_PICKABLE_STEP_RANGE = 24;
...
const BACKGROUND_IMAGE_MAX_WIDTH_FIT_CANVAS_WHEN_MORNING =
  (EXHIBITION_2D_CANVAS_HEIGHT / BACKGROUND_IMAGE_MAX_HEIGHT_WHEN_MORNING) *
  BACKGROUND_IMAGE_MAX_WIDTH_WHEN_MORNING;
...
export const EXHIBITION_2D_MORNING_BACKGROUND_MAX_STEP = 151;
...
export const EXHIBITION_2D_CHARACTER_MAX_STEP_WHEN_MORNING = Math.floor(
  (BACKGROUND_IMAGE_MAX_WIDTH_FIT_CANVAS_WHEN_MORNING -
    EXHIBITION_2D_CHARACTER_WIDTH) /
    EXHIBITION_2D_MOVING_DISTANCE_PER_STEP
) - 1; // 頭が突き刺さってしまっていたので...
